...
<body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="navbar-header"><a class="navbar-brand" href="?p=index">Codetechnos Admin</a></div>
        <!-- Top Menu Items -->
        <ul class="nav navbar-right top-nav">
            ...
            <li class="dropdown">
				<a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> <?php echo $_SESSION['user_real_name']; ?> <b class="caret"></b></a>
		...
		<div class="collapse navbar-collapse navbar-ex1-collapse">
			<ul class="nav navbar-nav side-nav">
				<li><a href="?p=dashboard"><i class="fa fa-fw fa-dashboard"></i> Dashboard</a></li>
				<li><a href="?p=user"><i class="fa fa-fw fa-user"></i> Users</a></li>
				<li><a href="?p=package "><i class="fa fa-fw fa-dropbox"></i> Packages </a></li>
				<!--<li ><a href="?p=content"><i class="fa fa-fw fa-table"></i> Tables</a></li>
